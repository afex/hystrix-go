...
[![GoDoc Documentation](http://godoc.org/github.com/presencelearning/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/presencelearning/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/presencelearning/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/presencelearning/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/presencelearning/hystrix-go```
- ```go test ./...```
