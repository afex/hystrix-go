...
[![Build Status](https://travis-ci.org/tietang/hystrix-go.png?branch=master)](<https://travis-ci.org/tietang/hystrix-go>)
[![GoDoc Documentation](http://godoc.org/github.com/tietang/hystrix-go/hystrix?status.png)](<https://godoc.org/github.com/tietang/hystrix-go/hystrix>)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/tietang/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/tietang/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/tietang/hystrix-go```
- ```go test ./...```
